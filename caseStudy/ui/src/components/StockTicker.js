...
class StockTicker extends React.Component {
    ...
    loadDoc(me,name) {
        ...
        xhttp.open("GET", "http://gsee.pythonanywhere.com/"+name, true);
        xhttp.send();
      }
      loadOpts(me) {
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
           ...
           console.log(this.responseText);
           const g = JSON.parse(this.response);
            me.setState({opts:g['a']});
        }
        };
        xhttp.open("GET", "http://gsee.pythonanywhere.com/list", true);
        xhttp.send();
      }
    constructor(props) {
        super(props);
    ...
    render() {
         ...
         */
console.log("here300  "+ this.state.h);
        ...
        return (
            <div className="stockticker">
                ...
                <div>
                    ...
                    <p>{this.state.company.headquartersCity}</p>
                    <p>{this.state.company.headquartersStateOrCountry}</p>
                    <p>{this.state.company.sector}</p>
                    <p>{this.state.company.industry}</p>
                    <Charts stock={this.state.h}/>
